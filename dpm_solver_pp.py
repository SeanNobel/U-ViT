...
class NoiseScheduleVP:
    def __init__(
        ...
        if schedule not in ["linear", "discrete", "cosine"]:
            raise ValueError("Unsupported noise schedule {}. The schedule needs to be 'linear' or 'cosine'".format(schedule))  # fmt: skip
...
def model_wrapper(
    ...
    def get_model_input_time(t_continuous):
        ...
        if time_input_type == "0":
            ...
            raise ValueError(
                "Unsupported time input type {}, must be '0' or '1' or '2'".format(time_input_type)
            )
